...
Then, to tunnel a SSL connection on 50332 to a RPC server bound on localhost on port 40332 do:

    stunnel -d 50332 -r 127.0.0.1:40332 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcoinrpc>
        ProxyPass http://127.0.0.1:30332/
        ProxyPassReverse http://127.0.0.1:30332/
