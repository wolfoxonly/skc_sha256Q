...
//! -paytxfee default
static const CAmount DEFAULT_TRANSACTION_FEE = 1;//coingo.vip
//! -fallbackfee default
static const CAmount DEFAULT_FALLBACK_FEE = 1;//coingo.vip
//! -m_discard_rate default
static const CAmount DEFAULT_DISCARD_FEE = 1;//coingo.vip
//! -mintxfee default
static const CAmount DEFAULT_TRANSACTION_MINFEE = 1;//coingo.vip
